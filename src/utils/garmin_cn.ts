                    ...
                    if (sheetsService) {
                        ...
                        if (!hasExisting) {
                            ...
                            activityMetrics.push({
                                ...
                                locationName: actMetrics.locationName,
                                ...
                                maxSpeed: actMetrics.maxSpeed,
                                avgCadence: actMetrics.avgCadence,
                                maxCadence: actMetrics.maxCadence,
                                avgPower: actMetrics.avgPower,
                                avgVerticalOscillation: actMetrics.avgVerticalOscillation,
