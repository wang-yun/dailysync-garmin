...
export const mapActivityFromGarmin = (activity: Record<string, any>): ActivityMetrics => {
    const {
        ...
        avgVerticalOscillation = activity.avgVerticalOscillation ?? undefined,
        avgVerticalRatio = activity.avgVerticalRatio ?? undefined,
        avgGroundContactTime = activity.avgGroundContactTime ?? undefined,
        avgGroundContactBalance = activity.avgGroundContactBalance ?? undefined,
        avgStrideLength = activity.avgStrideLength ?? undefined,
        elevationGain,
        ...
        minRespirationRate = activity.minRespirationRate ?? activity.minRespiratoryRate ?? undefined,
        maxRespirationRate = activity.maxRespirationRate ?? activity.maxRespiratoryRate ?? undefined,
    } = activity;
    ...
    return {
        ...
        minRespiration: minRespirationRate,
        maxRespiration: maxRespirationRate,
    };
};
